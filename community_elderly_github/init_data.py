"""
初始化脚本 - 创建管理员账号和测试数据
运行方式：python manage.py shell < elderly_system/init_data.py
或者直接：python init_data.py（在 manage.py 同目录下）
"""
import os
import sys
import django
...
# 创建测试老年用户
test_users = [
    {'username': 'user1', 'first_name': '张大爷', 'phone': '13800000001', 'age': 68, 'area': '东城区'},
    {'username': 'user2', 'first_name': '李奶奶', 'phone': '13800000002', 'age': 72, 'area': '西城区'},
    {'username': 'user3', 'first_name': '王大妈', 'phone': '13800000003', 'age': 65, 'area': '东城区'},
]
for u in test_users:
